...
Cluster is based on Virtuozzo certified Elastic Standalone LLSMP containers. LLSMP container is created from (Linux + LiteSpeed + MariaDB + PHP) template with a set of built-in advanced features.
...
[LiteSpeed Web Server](https://docs.jelastic.com/litespeed-web-server) (LSWS) is a high-performance and low memory consuming web server. It includes ESI caching, browser, and object cache along with the support of HTTP/3, CDN, WAF, Geo-DNS, reCAPTCHA protection, cutting-edge anti-DDoS protection.  
...
Find an **Multi-Regon WordPress Standalone** application in the [Marketplace](https://www.virtuozzo.com/application-platform-docs/marketplace/). And press Intsall.

 
## Installation Process

Upon the package installation, new environments will be created, one environment per one [Region](https://www.virtuozzo.com/application-platform-docs/environment-regions). Number of Regions for this solution is 2.
