function DBRecovery() {
    ...
    me.execRecovery = function(values) {
        values = values || {};
        api.marketplace.console.WriteLog("curl --silent https://cdn.jsdelivr.net/gh/jelastic-jps/mysql-cluster@master/addons/recovery/scripts/db-recovery.sh > /tmp/db-recovery.sh && bash /tmp/db-recovery.sh " + me.formatRecoveryAction(values));
